  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
        ...
        className="w-full h-full text-lg bg:transparent  outline-none border-none placeholder-gray-500 text-textColor"></input>
      </div>
    ...
    <div className="group flex justify-center items-center flex-col border-2 border-dotted
     ...
     <div className="relative h-full">
      ...
      onClick={deleteImage}>
        <MdDelete className="text-white"></MdDelete></button></div></>)}
     </>)}
    </div>
    ...
    <div className="w-full flex flex-col md:flex-row items-center gap-3">
      <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
       ...
       className="h-full w-full text-lg bg-transparent outline-none
       border-none placeholder:text-gray-400" ></input>
    ...
    <div className="flex items-center w-full">
      <button type="button" className="ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg
